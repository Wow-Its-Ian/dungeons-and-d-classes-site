...
function NavBar() {
  ...
  return (
	<nav style={{position: 'fixed', display: 'flex', width: '100%', alignItems: 'center', justifyContent: 'space-around', paddingTop: '1em', paddingBottom: '1em', backgroundColor: 'rgba(255, 255, 255, 0.8)'}}>
